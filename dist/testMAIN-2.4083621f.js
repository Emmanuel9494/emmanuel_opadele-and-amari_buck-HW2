...
var _worldClockJs = require("./WorldClock.js");
var _animationJs = require("./animation.js");
(0, _animationJs.ClockAnimations)();
...
class WorldClockApp {
    ...
    fetchTimezones() {
        try {
            ...
            this.timezones = [
                'UTC'
            ]; // Fallback if no timezones are available
        }
    }
    // this is the method that populates the dropdown menu with the timezones - also handles the formatting of the timezones
    populateTimezoneSelect() {
        this.timezoneSelect.innerHTML = this.timezones.map((tz)=>`<option value="${tz}">${tz.replace('_', ' ').replace('/', ' / ')}</option>`).join('');
    }
    showModal() {
    ...
    createClock() {
        ...
        if (!this.clocks.has(timezone)) {
            const clock = new (0, _worldClockJs.WorldClock)(timezone, this.container); // creates a new clock instance
    ...
    loadSavedClocks() {
        ...
        if (saved) JSON.parse(saved).forEach((timezone)=>{
            if (!this.clocks.has(timezone)) {
                const clock = new (0, _worldClockJs.WorldClock)(timezone, this.container);
...
},{"./WorldClock.js":"lOJeL","./animation.js":"9sz9S"}],"lOJeL":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "WorldClock", ()=>WorldClock);
class WorldClock {
...
},{}],"9sz9S":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ClockAnimations", ()=>ClockAnimations);
function ClockAnimations() {
        ...
        const observer = new MutationObserver((mutations)=>{
            mutations.forEach((mutation)=>{
                mutation.addedNodes.forEach((node)=>{
                    if (node.classList && node.classList.contains('clock')) // Animate new clock entry
                    gsap.from(node, {
                        scale: 0.8,
                        opacity: 0,
                        duration: 0.5,
    ...
    function initModalAnimations() {
        ...
        function animateModalShow() {
            if (modal.style.display === 'block') gsap.from('.modal-content', {
                y: -50,
                opacity: 0,
                duration: 0.3,
                ease: 'power3.out'
        ...
        const observer = new MutationObserver((mutations)=>{
            mutations.forEach((mutation)=>{
                if (mutation.type === 'attributes' && mutation.attributeName === 'style') animateModalShow();
            });
        });
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["9ObT8","bqx5n"], "bqx5n", "parcelRequiref770")

//# sourceMappingURL=testMAIN-2.4083621f.js.map
